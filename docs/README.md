# AIByDM Documentation

This folder is the documentation hub for contributors, maintainers, and anyone evaluating the
project as an open-source platform.

## Documentation Map

| Path                                                     | Purpose                                                     |
| -------------------------------------------------------- | ----------------------------------------------------------- |
| [getting-started/README.md](./getting-started/README.md) | Local setup and first-day workflow                          |
| [development/README.md](./development/README.md)         | Scripts, standards, and development lifecycle               |
| [deployment/README.md](./deployment/README.md)           | GitHub Pages deployment and release flow                    |
