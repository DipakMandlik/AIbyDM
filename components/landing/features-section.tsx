...
const features = [
  {
    ...
    description: "Every track ends in something real. You learn by building, shipping, and sharing projects, not by watching passively.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Adaptive AI tutor",
    description: "Get unstuck instantly. Your built-in tutor explains concepts at your level and adapts as your understanding grows.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Learn with others",
    description: "Join study cohorts, compare progress, and contribute in the open. Knowledge compounds when you learn together.",
    visual: "collab",
  },
  {
    number: "04",
    title: "Always current",
    description: "AI moves fast. Lessons, tools, and questions are reviewed and refreshed continuously so you never learn stale material.",
    visual: "security",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Learning that
            <br />
            <span className="text-muted-foreground">actually sticks.</span>
          </h2>
        </div>
