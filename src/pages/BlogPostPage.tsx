...
// Import the blogs data - this would typically come from an API
// We're using the same data from BlogsPage for this example
const blogs = [
  {
    id: 1,
...
export default function BlogPostPage() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-black via-purple-950/20 to-black pt-24 pb-16 px-4 flex items-center justify-center">
    ...
    <div className="min-h-screen bg-gradient-to-b from-black via-purple-950/20 to-black pt-20 pb-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        <motion.div
          ...
          className="mb-8"
        >
          <Link to="/blogs" className="inline-flex items-center text-purple-400 hover:text-purple-300 transition-colors mb-6">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-6">{blog.title}</h1>
          
          <div className="flex flex-wrap gap-2 mb-6">
            {blog.tags.map((tag: string, i: number) => (
              <span key={i} className="text-xs bg-purple-900/30 text-gray-300 px-2 py-1 rounded-full">
              ...
              {relatedPosts.map((post, index) => (
                ...
                >
                  <Link to={`/blogs/${post.id}`} className="group">
                    ...
                    <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-purple-400 transition-colors">{post.title}</h3>
                    <div className="flex items-center text-sm text-gray-400">
                      <span>{post.date}</span>
                      <span className="mx-2">•</span>
